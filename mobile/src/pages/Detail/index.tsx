...
const Detail: React.FC = () => {
  ...
  const defaultContactMessage = "Interesse na coleta de resíduos";
  ...
  const handleWhatsapp = () => {
    Linking.openURL(
      `whatsapp://send?phone=${data.point.whatsapp}&text=${defaultContactMessage}`
    );
  };
